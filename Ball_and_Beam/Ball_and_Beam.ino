...
void loop() {
    Kp=  double(map(analogRead(potKp),0,1023,0,100.00));
    Ki=  double( map(analogRead(potKi),0,1023,0,50.00));
    Kd=  double( map(analogRead(potKd),0,1023,0,50.00));
    Kp=((analogRead(potKp)/1024.0)*(KpMax-KpMin))+KpMin;
    Ki=((analogRead(potKi)/1024.0)*(KiMax-KiMin))+KiMin;
    Kd=((analogRead(potKd)/1024.0)*(KdMax-KdMin))+KdMin;
